import {whiteEditIcon, lockIcon, publicIcon, whiteDeleteIcon } from "../../../assets/icons.js";
...
export function initCard(name, author, isPublic, firstTag = '(0)'){
    ...
    <div class="book-container position-relative display-flex">
        <div class="book-background position-absolute display-flex">
            <div class="flex-1 edit-background display-flex flex-direction-row align-items-center padding-horizontal-36px">${whiteEditIcon}</div>
        ...
        <div id="${author}ѳлѧсїс${name}" class="book-style book display-flex flex-direction-row align-items-center justify-content-space-between padding-12px position-relative">
